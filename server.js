...
if (!process.env.JWT_SECRET) {
  console.warn('⚠️  JWT_SECRET não configurada no Render — usando valor padrão INSEGURO. Configure JWT_SECRET nas variáveis de ambiente.');
}
if (!process.env.ADMIN_PASSWORD) {
  console.warn('⚠️  ADMIN_PASSWORD não configurada no Render — usando senha padrão INSEGURA. Configure ADMIN_PASSWORD nas variáveis de ambiente.');
}
...
// Serve apenas o index.html (single-page app). Não expõe o diretório inteiro
// do projeto (server.js, package.json etc.) como o express.static(__dirname) fazia.
